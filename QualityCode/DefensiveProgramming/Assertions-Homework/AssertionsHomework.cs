...
class AssertionsHomework
{
        ...
        where T : IComparable<T>
    {
        ...
        Debug.Assert(startIndex >= 0, "starIndex cannot be less than zero.");
        Debug.Assert(endIndex >=0, "endIndex cannot be less than zero.");
    ...
    public static int BinarySearch<T>(T[] arr, T value) where T : IComparable<T>
    {
        ...
        {
            Debug.Assert(arr[i].CompareTo(arr[i + 1]) <= 0, "The array must be sorted!");
        }
